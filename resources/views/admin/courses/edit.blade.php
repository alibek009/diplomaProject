        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('teachers[]', $teachers, old('teachers') ? old('teachers') : $course->teachers->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-teachers' ]) !!}
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12 form-group">
                        {!! Form::label('grade', trans('Grade').'', ['class' => 'control-label']) !!}
